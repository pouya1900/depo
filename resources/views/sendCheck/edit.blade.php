                    ...
                    <div class="col-md-6 col-12">
                        <form method="post" action="{{route('update_send_check',$check->id)}}">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="bank" name="bank" value="{{$check->bank}}">
                            </div>
