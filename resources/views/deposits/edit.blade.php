            ...
            <div class="content_box">
                <div class="row justify-center">
                    <div class="col-md-6 col-12">
                        <form method="post" action="{{route('update_deposit',$deposit->id)}}">
                            {{csrf_field()}}
                            ...
                            <div class="input-group">
                                ...
                                <select name="member" id="member">
                                    ...
                                    @foreach($members as $member)
                                        <option
                                            {{$deposit->member->id==$member->id ? "selected" : ""}} value="{{$member->id}}">{{$member->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" value="{{$deposit->reason}}" class="form-control" id="reason"
                                       name="reason">
                            </div>
